...
public sealed class AncientWildness : CustomCardModel
{
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        [HoverTipFactory.Static(StaticHoverTip.Block), HoverTipFactory.FromPower<WildnessPower>()];
    ...
    public AncientWildness()
        : base(1, CardType.Skill, CardRarity.Ancient, TargetType.Self, autoAdd: false)
    {
    }
